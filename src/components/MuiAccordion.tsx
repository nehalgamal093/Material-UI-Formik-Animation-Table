  ...
  return (
    <div>
        <Accordion expanded={expanded === 'panel1'} onChange={(event,isExpanded)=>handleChange(isExpanded,'panel1') }>
            ...
            <AccordionDetails>
                <Typography>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut ad natus culpa esse incidunt aut, amet inventore quisquam, magni magnam voluptatum consequuntur voluptates dicta, neque nostrum dolorem molestias itaque voluptatibus!</Typography>
            </AccordionDetails>
        </Accordion>
